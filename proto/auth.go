...
func (a *Auth) Pack(capabilityFlags uint32, charset uint8, username string, password string, salt []byte, database string) []byte {
	...
	//hex_string_data := "7e035f6f730757696e646f77730c5f636c69656e745f6e616d650a6c69626d617269616462045f7069640434353630075f7468726561640435353332095f706c6174666f726d05414d4436340f5f636c69656e745f76657273696f6e05332e322e330c5f7365727665725f686f73740f3133392e3139362e3230322e313537"
	//hex_data, _ := hex.DecodeString(hex_string_data)
	//buf.WriteBytes(hex_data)
	return buf.Datas()
}
